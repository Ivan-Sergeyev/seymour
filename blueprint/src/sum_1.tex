...
\begin{definition}
    ...
    \uses{StandardRepr,def:one_sum_matrix}
    % \lean{}
    \leanok
...
\begin{lemma}
    ...
    \uses{def:one_sum_matrix,Matrix.IsTotallyUnimodular}
    % \lean{}
    \leanok
...
\begin{proof}
    \uses{def:one_sum_matrix,Matrix.IsTotallyUnimodular,lem:det_lower_left_zero}
    \leanok
...
\begin{theorem}
    ...
    \uses{def:one_sum_matroid,Matroid.IsRegular}
    % \lean{}
    \leanok
...
\begin{proof}
    \uses{StandardRepr,def:one_sum_matroid,Matroid.IsRegular,StandardRepr.toMatroid_isRegular_iff_hasTuSigning,lem:one_sum_tu,Matrix.IsTuSigningOf}
    \leanok
