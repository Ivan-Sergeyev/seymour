...
\begin{definition}
    ...
    \uses{StandardRepr,standardRepr1sumComposition}
    % \lean{}
    \leanok
...
\begin{lemma}
    ...
    \uses{standardRepr1sumComposition,Matrix.IsTotallyUnimodular}
    % \lean{}
    \leanok
...
\begin{proof}
    \uses{standardRepr1sumComposition,Matrix.IsTotallyUnimodular,lem:det_lower_left_zero}
    \leanok
...
\begin{proof}
    \uses{StandardRepr,Matroid.Is1sumOf,Matroid.IsRegular,StandardRepr.toMatroid_isRegular_iff_hasTuSigning,lem:one_sum_tu,Matrix.IsTuSigningOf}
    \leanok
