...
\begin{proof}
    \uses{Matrix.IsTuSigningOf,Matrix.IsTotallyUnimodular.mul_rows,Matrix.IsTotallyUnimodular.mul_cols,Matrix.IsTotallyUnimodular,lem:three_sum_signing_S_TU}
    % \leanok
    ...
    \begin{enumerate}
        ...
        which contradicts TUness of $Q'$. Thus, $Q' (x_{1}, y_{1}) = 1 = S' (x_{1}, y_{1})$.
    \end{enumerate}
    % TODO how is lem:three_sum_signing_S_TU used in the proof?
\end{proof}
...
\begin{proof}
    \uses{StandardRepr,Matroid.Is3sumOf,StandardRepr.toMatroid_isRegular_iff_hasTuSigning,def:three_sum_signing_B,lem:three_sum_signing_B_valid,lem:three_sum_signing_B_tu}
    % \leanok
