...
\begin{proof}
    \uses{lem:three_sum_like_signing_B,MatrixLikeSum3.IsTotallyUnimodular}
    \leanok
    Combine the results of Lemmas~\ref{lem:three_sum_like_signing_B} and~\ref{MatrixLikeSum3.IsTotallyUnimodular}.
    % By Lemma~\ref{lem:three_sum_like_signing_B}, $B'' \in \mathcal{C} (X_{\ell}, Y_{\ell}, X_{r}, Y_{r}; c_{0}'', c_{1}'')$, and by Lemma~\ref{MatrixLikeSum3.IsTotallyUnimodular}, every matrix in $\mathcal{C} (X_{\ell}, Y_{\ell}, X_{r}, Y_{r}; c_{0}'', c_{1}'')$ is TU.
\end{proof}
