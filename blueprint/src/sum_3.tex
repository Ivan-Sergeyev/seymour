...
\begin{definition}
    ...
    \uses{def:three_sum_matrix,def:std_repr}
    % \lean{}
    \leanok
...
\begin{lemma}
    ...
    \uses{def:three_sum_signing_S,def:tu}
    % \lean{}
    \leanok
...
\begin{lemma}
    ...
    \uses{def:tu_signing,def:three_sum_signing_S}
    % \lean{}
    \leanok
...
\begin{proof}
    \uses{def:tu_signing,lem:tu_mul_row_col_pnz,def:tu}
    % \leanok
...
\begin{lemma}
    ...
    \uses{def:tu_signing,def:three_sum_signing_S,def:three_sum_re_signing}
    % \lean{}
    \leanok
...
\begin{proof}
    \uses{def:tu_signing,lem:tu_mul_row_col_pnz,lem:three_sum_re_signing_helper}
    % \leanok
...
\begin{definition}
    ...
    \uses{def:three_sum_matrix,def:tu_signing,def:three_sum_re_signing}
    % \lean{}
    \leanok
...
\begin{proof}
    \uses{lem:three_sum_re_signing_apply,def:tu_signing}
    % \leanok
...
\begin{proof}
    \uses{lem:three_sum_re_signing_apply,def:tu,def:stp,lem:stp_tu,lem:tu_mul_row_col_pnz}
    % \leanok
...
\begin{lemma}
    ...
    \uses{def:three_sum_signing_B,def:tu}
    % \lean{}
    \leanok
...
\begin{proof}
    \uses{lem:three_sum_signing_B_r_props,lem:three_sum_signing_B_l_props,def:tu}
    % \leanok
    \begin{enumerate}
...
\begin{lemma}
    ...
    \uses{def:three_sum_like_matrix,def:stp}
    % \lean{}
    \leanok
...
\begin{proof}
    \uses{lem:stp_block_zero,def:tu,lem:stp_tu}
    % \leanok
...
\begin{lemma}
    ...
    \uses{def:three_sum_like_matrix,def:tu}
    % \lean{}
    \leanok
...
\begin{proof}
    \uses{def:three_sum_like_matrix,lem:tu_iff_all_pu,lem:stp_pn_abs_det_eq,lem:three_sum_like_pivot}
    % \leanok
...
\begin{theorem}
    ...
    \uses{def:three_sum_matroid,def:regular}
    % \lean{}
    \leanok
...
\begin{proof}
    \uses{def:std_repr,def:three_sum_matroid,lem:regular_defs_equiv,def:three_sum_signing_B,lem:three_sum_signing_B_valid,lem:three_sum_signing_B_tu}
    % \leanok
