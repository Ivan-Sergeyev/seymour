...
\begin{proof}
    \uses{Matrix.isTotallyUnimodular_iff_forall_isPartiallyUnimodular,matrix2sumComposition,Matrix.IsTotallyUnimodular.fromCols_outer,shortTableauPivot_submatrix_det_abs_eq_div,matrix2sumComposition_shortTableauPivot}
    \leanok
