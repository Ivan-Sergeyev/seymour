...
\begin{proof}
    \uses{Matrix.isTotallyUnimodular_iff_forall_isPartiallyUnimodular,matrix2sumComposition,lem:two_sum_bottom_tu,shortTableauPivot_submatrix_det_ni_signTypeCastRange,lem:two_sum_pivot}
    \leanok
...
\begin{proof}
    \uses{StandardRepr,Matroid.Is2sumOf,StandardRepr.toMatroid_isRegular_iff_hasTuSigning,lem:two_sum_tu,Matrix.IsTuSigningOf}
    \leanok
