...
\end{definition} % TODO add the conditions on intersections and maybe nonzeros, then rename to standardReprSum2

\begin{definition}
    \label{Matroid.Is2sumOf}
    \uses{Matroid,StandardRepr,matrixSum2}
    % \lean{}
    \leanok
...
\begin{lemma}
    ...
    \uses{matrixSum2,Matrix.IsTotallyUnimodular}
    % \lean{}
    \leanok
...
\begin{proof}
    \uses{matrixSum2,Matrix.IsTotallyUnimodular,Matrix.IsTotallyUnimodular.mul_cols}
    \leanok
...
\begin{lemma}
    ...
    \uses{matrixSum2,Matrix.shortTableauPivot}
    % \lean{}
    \leanok
...
\begin{proof}
    \uses{matrixSum2,Matrix.shortTableauPivot,Matrix.shortTableauPivot_zero,Matrix.shortTableauPivot_eq}
    \leanok
    Let
    \[
        B_{\ell}' = \begin{bmatrix} A_{\ell}' \\ r' \end{bmatrix}, \quad
...
\begin{proof}
    \uses{Matrix.isTotallyUnimodular_iff_forall_isPartiallyUnimodular,matrixSum2,Matrix.IsTotallyUnimodular.fromCols_outer,shortTableauPivot_submatrix_det_abs_eq_div,matrixSum2_shortTableauPivot,Matrix.IsTotallyUnimodular.shortTableauPivot}
    \leanok
...
\begin{proof}
    \uses{StandardRepr,Matroid.Is2sumOf,StandardRepr.toMatroid_isRegular_iff_hasTuSigning,matrixSum2_isTotallyUnimodular,Matrix.IsTuSigningOf}
    \leanok
