...
\end{lemma} % TODO this one is used in the 2-sum file, too
...
\end{definition}
% TODO this lemma is used somewhere.
\begin{lemma}
...
\begin{lemma}
    ...
    \uses{StandardRepr,def:fund_circuit}
    % \lean{}
...
\begin{lemma}
    ...
    \uses{StandardRepr,Matrix.support}
    % \lean{}
...
\begin{proof}
    \uses{Matroid.IsRegular,Matrix.IsTuSigningOf,StandardRepr.toMatroid_isBase_X,VectorMatroid.exists_standardRepr_isBase_isTotallyUnimodular,lem:std_repr_support_matrix_cols,Matrix.IsTotallyUnimodular.toMatroid_eq_support_toMatroid}
    \leanok
