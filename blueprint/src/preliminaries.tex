...
\begin{definition}
    ...
    \uses{Matrix}
    \leanok
    Let $A$ be a square matrix over a commutative ring.
    Determinant of $A$ is the sum over all permutations, sign of the permutation times the product of (TODO write properly).
\end{definition}
